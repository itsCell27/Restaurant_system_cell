...
public class DrinksAndDessertMenu {
    ...
    // Method to display the Drinks and Desserts menu and process orders
    public void displayMenu(Scanner scanner, HandleMyOrder handleOrder) {
        ...
        // Filter the items that belong to the "Drinks" or "Desserts" category
        ...
        if (drinksAndDessertsMenu.isEmpty()) {
            System.out.println("\t\t\tError: No items found in the Drinks and Desserts menu.");
            System.out.println("\t\t\tPress ENTER to continue...");
            scanner.nextLine();
            return;
        }

        // Print the drinks and desserts menu in tabular format
        System.out.println("\t\t\t\t\t\tDRINKS AND DESSERTS MENU\n");
        System.out.println("\t\t\t===================================================================");
        System.out.printf("\t\t\t| %-5s | %-36s | %-16s |\n", "No.", "Item", "Price");
        System.out.println("\t\t\t===================================================================");
        for (int i = 0; i < drinksAndDessertsMenu.size(); i++) {
            MenuItem item = drinksAndDessertsMenu.get(i);
